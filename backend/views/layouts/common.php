        ...
        <section class="sidebar">
            ...
            <?php echo Menu::widget([
                ...
                'items' => [
                    ...
                    [
                        'label' => Yii::t('backend', 'Kết quả xổ số'),
                        'icon' => '<i class="fa fa-bar-chart-o"></i>',
                        'url' => ['/result/ket-qua-xo-so'],
                        'badge' => TimelineEvent::find()->today()->count(),
                        'badgeBgClass' => 'label-success',
                    ],

                    [
                        'label' => Yii::t('backend', 'Vietlot 655'),
                        'icon' => '<i class="fa fa-bar-chart-o"></i>',
                        'url' => ['result/vietlott655'],
                        'badge' => TimelineEvent::find()->today()->count(),
                        'badgeBgClass' => 'label-success',
                    ],

                    [
                        'label' => Yii::t('backend', 'Mega645'),
                        'icon' => '<i class="fa fa-bar-chart-o"></i>',
                        'url' => ['result/mega645'],
                        'badge' => TimelineEvent::find()->today()->count(),
                        'badgeBgClass' => 'label-success',
...
//                    ],
    ...
    <footer class="main-footer">
        <strong>diepnv@hellomedia.vn</strong>
        <div class="pull-right">Development by nvdiepse@gmail.com</div>
  </footer>
</div><!-- ./wrapper -->
